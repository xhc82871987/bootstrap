...
- It must be used on a Bootstrap [nav component]({{ .Site.BaseURL }}/docs/{{< param docs_version >}}/components/navs/) or [list group]({{ .Site.BaseURL }}/docs/{{< param docs_version >}}/components/list-group/).
